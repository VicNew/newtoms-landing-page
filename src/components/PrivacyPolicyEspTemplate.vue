<template>
    <div class="container">
        ...
        <p>Fecha efectiva: November 02, 2018</p>
        <p>NEWTOMS LLC ("nosotros", "a nosotros", "nuestro") opera el sitio web https://www.newtoms.com/ (en adelante, el "Servicio").</p>
        ...
        <p>Utilizamos sus datos para prestarle el Servicio y mejorarlo. Al utilizar el Servicio, usted acepta la recopilación y el uso de información de conformidad con esta política. A menos que esta Política de privacidad defina lo contrario, los términos utilizados en ella tienen los mismos significados que nuestros Términos y Condiciones, disponibles en el https://www.newtoms.com/</p>
        <h2>Definiciones</h2>
        <ul>
            <li>
                <p><strong>Servicio</strong></p>
                <p>Servicio es el sitio web https://www.newtoms.com/ operado por NEWTOMS LLC</p>
            </li>
            <li>
        ...
        <h2>Uso de datos</h2>
        <p>NEWTOMS LLC utiliza los datos recopilados con diversas finalidades:</p>
        <ul>
        ...
        <p>Si usted se encuentra fuera de United States Minor Outlying Islands y decide facilitarnos información, tenga en cuenta que nosotros transferimos los datos, incluyendo Datos personales, a United States Minor Outlying Islands y que los tratamos allí.</p>
        ...
        <ul>
            <li>Por e-mail: info@newtoms.com</li>
        </ul>
        <br>
    </div>
</template>
